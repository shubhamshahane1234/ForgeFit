    ...
    <footer className="footer" role="contentinfo">
      <div className="container">
        ...
        >
          ...
          <div className="footer__brand">
            <a href="#home" className="footer__logo" aria-label="FORGE – Home">
              <span className="footer__logo-mark" aria-hidden="true">F</span>
              <span className="footer__logo-text">FORGE</span>
            </a>
            <p className="footer__tagline">Next-gen fitness for the relentless. Push your limits. Redefine possible.</p>
          ...
          <div className="footer__info">
            ...
            <ul role="list">
              <li><span>Mon – Fri</span><span>5:00 AM – 11:00 PM</span></li>
              <li><span>Saturday</span><span>6:00 AM – 10:00 PM</span></li>
              <li><span>Sunday</span><span>7:00 AM – 8:00 PM</span></li>
            </ul>
          </div>
          ...
          <div className="footer__info">
            ...
            <address>
              <p>1420 Iron Street</p>
              <p>San Francisco, CA 94107</p>
              <p style={{ marginTop: '12px' }}>
                <a href="tel:+15551234567" className="footer__nav-link">+1 (555) 123-4567</a>
              </p>
              <p>
                <a href="mailto:hello@forgegym.com" className="footer__nav-link">hello@forgegym.com</a>
              </p>
            </address>
          </div>
        </motion.div>
        ...
        <div className="footer__bottom">
          <p>&copy; {new Date().getFullYear()} FORGE Gym. All rights reserved.</p>
